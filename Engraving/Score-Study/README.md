...
[`../../Documentation/Project-Management/FALL_2026_WORKING_TEXT.md`](../../Documentation/Project-Management/FALL_2026_WORKING_TEXT.md).
...
```bash
python3 Operations/Scripts/build_full_version_section_model.py
```
