...
`Source/` is the complete recovered set of editable Flashlights in the Dark Finale `.musx` files. `Backups/` preserves the corresponding automatic/manual Finale backup files. Filenames—including dated edition and score identifiers—are intentionally unchanged.
