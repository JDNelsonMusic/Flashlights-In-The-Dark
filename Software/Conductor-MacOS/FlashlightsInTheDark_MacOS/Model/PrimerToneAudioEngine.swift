    ...
    func preloadPrimerTones() {
        ...
        let fallbackDirectories = [
            URL(fileURLWithPath: FileManager.default.currentDirectoryPath)
                .appendingPathComponent("Software/Conductor-MacOS/FlashlightsInTheDark_MacOS/Audio/primerTones", isDirectory: true),
            URL(fileURLWithPath: FileManager.default.currentDirectoryPath)
                .appendingPathComponent("Software/Conductor-MacOS/FlashlightsInTheDark_MacOS/Audio", isDirectory: true)
        ]
