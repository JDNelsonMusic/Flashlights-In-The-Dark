...
const isPublicBuild = process.env.BUILD_TARGET === 'public';
...
const publicEntries = {
  ...
  documentation: resolve(import.meta.dirname, 'src/documentation.jsx'),
  install: resolve(import.meta.dirname, 'src/install.jsx'),
...
export default defineConfig({
  ...
  build: isLibraryBuild || isPublicBuild
    ? {
        ...
        manifest: isPublicBuild,
        lib: {
          entry: {
            ...(isLibraryBuild ? { index: resolve(import.meta.dirname, 'src/index.jsx') } : {}),
            ...publicEntries,
          },
          formats: ['es'],
