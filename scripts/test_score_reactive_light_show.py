...
SCORE_PATH = ROOT / "flashlights_client/assets/FlashlightsInTheDark_v26_NewerScoreWithFewerParts.musicxml"
TRIGGER_MANIFEST_PATH = ROOT / "docs/protools-housekeeping/electronics_trigger_assets.json"
BASELINE_LIGHT_SHOW_PATH = ROOT / "docs/score-study/twelve_trigger_light_show.json"
GRAMMAR_PATH = ROOT / "docs/score-study/score_reactive_light_grammar_full_version.json"
...
class ScoreReactiveLightShowTests(unittest.TestCase):
    ...
    def setUpClass(cls) -> None:
        ...
        cls.manifest = build_score_reactive_manifest(
            ...
            grammar=cls.grammar,
            analysis_path=Path("docs/score-study/score_light_analysis_full_version.json"),
            grammar_path=Path("docs/score-study/score_reactive_light_grammar_full_version.json"),
        )
