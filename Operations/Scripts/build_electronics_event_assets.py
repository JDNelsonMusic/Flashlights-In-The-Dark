...
TIMELINE_PATH = ROOT / "DAW-Production" / "Audits" / "event_timeline.json"
FLUTTER_ASSET_ROOT = ROOT / "Software/Singer-Client" / "available-sounds" / "electronics-event-clips"
MANIFEST_JSON_PATH = ROOT / "DAW-Production" / "Audits" / "electronics_event_assets.json"
MANIFEST_CSV_PATH = ROOT / "DAW-Production" / "Audits" / "electronics_event_assets.csv"
RECIPE_COPY_PATHS = [
...
def variant_output_path(event_id: int, variant: ChoirVariant) -> Path:
    return ROOT / "Software/Singer-Client" / variant_asset_key(event_id, variant)
...
def patch_recipe_copy(path: Path, plans_by_id: dict[int, dict[str, Any]], generated_at: str) -> None:
    ...
    bundle["electronicsSource"] = "DAW-Production/Exports/electronics/2026_0314_FlashlightsInTheDark_Electronics-StereoSum_7.mp3"
    bundle["electronicsSyncReference"] = "DAW-Production/Audits/electronics_sync_reference.md"
    bundle["electronicsManifest"] = "DAW-Production/Audits/electronics_event_assets.json"
