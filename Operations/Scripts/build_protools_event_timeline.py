...
DEFAULT_RECIPE_JSON = ROOT / "Show-Control/Event-Recipes/Flashlights-ITD_EventRecipes_4_2026_0309" / "event_recipes.json"
DEFAULT_SCORE_XML = (
    ROOT / "Engraving" / "Scores" / "FlashlightsInTheDark_v32_TourCut.musicxml"
)
DEFAULT_OUTPUT_DIR = ROOT / "DAW-Production" / "Audits"
...
ASSET_ROOTS = {
    "flutter": ROOT / "Software/Singer-Client" / "available-sounds",
    "macos": ROOT / "Software/Conductor-MacOS/FlashlightsInTheDark_MacOS" / "Audio",
}
EVENT_RECIPE_COPIES = {
    "recipe_bundle": ROOT / "Show-Control/Event-Recipes/Flashlights-ITD_EventRecipes_4_2026_0309" / "event_recipes.json",
    "macos": ROOT / "Software/Conductor-MacOS/FlashlightsInTheDark_MacOS" / "Resources" / "event_recipes.json",
    "flutter": ROOT / "Software/Singer-Client" / "assets" / "event_recipes.json",
}
