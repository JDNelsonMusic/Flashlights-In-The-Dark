...
IPA="/Users/JDNelson/AI_Dev/Flashlights-ITD_Client_2025-05-19 13-37-19/Software/Singer-Client.ipa"
APK="Software/Singer-Client/build/app/outputs/flutter-apk/app-release.apk"
...
if (( ${#ANDROID_SERIALS[@]} )); then
  ...
  (cd Software/Singer-Client && flutter build apk --release -q)
