...
FULL_SOURCE_MP3 = ROOT / "DAW-Production" / "Exports" / "electronics" / "2026_0314_FlashlightsInTheDark_Electronics-StereoSum_7.mp3"
CUT_SOURCE_MP3 = ROOT / "DAW-Production" / "Exports" / "electronics" / "2026_0314_FlashlightsInTheDark_Electronics-StereoSum_7_TourCut.mp3"
PRIMER_STEM_EXPORT_ROOT = ROOT / "DAW-Production" / "Exports" / "primer-stems"
MUSIQUE_CONCRETE_SOURCE_ROOT = (
    ROOT / "DAW-Production" / "Exports" / "musique-concrete"
)
FULL_SCORE_XML = ROOT / "Engraving" / "Scores" / "FlashlightsInTheDark_v26_NewerScoreWithFewerParts.musicxml"
CUT_SCORE_XML = ROOT / "Engraving" / "Scores" / "FlashlightsInTheDark_v32_TourCut.musicxml"
TOUR_TRIGGER_POINT_SOURCE = ROOT / "Engraving" / "Score-Study" / "tour_cut_trigger_points.csv"
FULL_TRIGGER_POINT_SOURCE = ROOT / "Engraving" / "Score-Study" / "full_version_trigger_points.csv"
TRIGGER_POINT_SOURCE = TOUR_TRIGGER_POINT_SOURCE
SYNC_REFERENCE_PATH = ROOT / "DAW-Production" / "Audits" / "electronics_sync_reference.md"
FLUTTER_ASSET_ROOT = (
    ROOT / "Software/Singer-Client" / "available-sounds" / "electronics-trigger-clips"
)
MANIFEST_JSON_PATH = (
    ROOT / "DAW-Production" / "Audits" / "electronics_trigger_assets.json"
)
MANIFEST_CSV_PATH = (
    ROOT / "DAW-Production" / "Audits" / "electronics_trigger_assets.csv"
)
RECIPE_COPY_PATHS = [
...
def variant_output_path(trigger_id: int, variant: ChoirVariant) -> Path:
    return ROOT / "Software/Singer-Client" / variant_asset_key(trigger_id, variant)
...
def part_concrete_output_path(trigger_id: int, variant: PartConcreteVariant) -> Path:
    return ROOT / "Software/Singer-Client" / part_concrete_asset_key(trigger_id, variant)
...
def part_variant_output_path(trigger_id: int, variant: PartConcreteVariant) -> Path:
    return ROOT / "Software/Singer-Client" / part_variant_asset_key(trigger_id, variant)
