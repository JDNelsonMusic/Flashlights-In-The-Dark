...
TRIGGER_MANIFEST_PATH = REPO_ROOT / "DAW-Production/Audits/electronics_trigger_assets.json"
TOUR_MUSICXML_PATH = REPO_ROOT / "Engraving/Scores/FlashlightsInTheDark_v32_TourCut.musicxml"
FULL_MUSICXML_PATH = REPO_ROOT / "Engraving/Scores/FlashlightsInTheDark_v26_NewerScoreWithFewerParts.musicxml"
MUSICXML_PATH = TOUR_MUSICXML_PATH
TOUR_LIGHT_SHOW_MANIFEST_PATH = REPO_ROOT / "Engraving/Score-Study/tour_cut_light_show.json"
FULL_LIGHT_SHOW_MANIFEST_PATH = REPO_ROOT / "Engraving/Score-Study/twelve_trigger_light_show.json"
FULL_SCORE_REACTIVE_LIGHT_SHOW_MANIFEST_PATH = (
    REPO_ROOT / "Engraving/Score-Study/twelve_trigger_light_show_score_reactive_v1.json"
)
FULL_SCORE_LIGHT_ANALYSIS_PATH = REPO_ROOT / "Engraving/Score-Study/score_light_analysis_full_version.json"
FULL_SCORE_REACTIVE_GRAMMAR_PATH = (
    REPO_ROOT / "Engraving/Score-Study/score_reactive_light_grammar_full_version.json"
)
LIGHT_SHOW_MANIFEST_PATH = TOUR_LIGHT_SHOW_MANIFEST_PATH

RECIPE_COPY_PATHS = [
    REPO_ROOT / "Show-Control/Event-Recipes/Flashlights-ITD_EventRecipes_4_2026_0309/event_recipes.json",
    REPO_ROOT / "Software/Conductor-MacOS/FlashlightsInTheDark_MacOS/Resources/event_recipes.json",
    REPO_ROOT / "Software/Singer-Client/assets/event_recipes.json",
]
