...
echo '== Flutter checks =='
pushd "$ROOT_DIR/Software/Singer-Client" >/dev/null
flutter pub get
...
xcodebuild \
  -project "$ROOT_DIR/Software/Conductor-MacOS/FlashlightsInTheDark.xcodeproj" \
...
python3 "$ROOT_DIR/Operations/Tools/concert_sim.py" \
