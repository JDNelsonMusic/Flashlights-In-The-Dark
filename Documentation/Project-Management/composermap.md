...
2. `Engraving/Score-Study/twelve_trigger_light_show.json`
3. `DAW-Production/Audits/event_timeline.md`
4. `DAW-Production/Audits/session_audit.md`
5. `Engraving/Scores/FlashlightsInTheDark_v26_NewerScoreWithFewerParts.musicxml`
6. `DAW-Production/ProTools-Session/2025_0727_FlashlightsInTheDark22_MappingPrimerTones_3.r.ptx`
