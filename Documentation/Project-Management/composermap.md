...
- active profile manifest: `Show-Control/Show-Profiles/show_profiles.json`
- active score source: `Engraving/Scores/FlashlightsInTheDark_v26_NewerScoreWithFewerParts.musicxml`
- active trigger map: `Engraving/Score-Study/full_version_trigger_points.csv`
- active light-show manifest: `Engraving/Score-Study/twelve_trigger_light_show.json`
- active runtime bundle: `Show-Control/Event-Recipes/Flashlights-ITD_EventRecipes_4_2026_0309/event_recipes.json`
...
The twin-poem Assembly capture is now the working text for the Fall 2026
edition. Read `Documentation/Project-Management/FALL_2026_WORKING_TEXT.md`
before changing the libretto. It preserves the 88-cue Shadow/Light contract
for a future engraving pass and is not already encoded in the current score or
runtime bundles.
...
2. `Documentation/Project-Management/FALL_2026_WORKING_TEXT.md`
3. `Engraving/Score-Study/twelve_trigger_light_show.json`
4. `DAW-Production/Audits/event_timeline.md`
5. `DAW-Production/Audits/session_audit.md`
6. `Engraving/Scores/FlashlightsInTheDark_v26_NewerScoreWithFewerParts.musicxml`
7. `DAW-Production/ProTools-Session/2025_0727_FlashlightsInTheDark22_MappingPrimerTones_3.r.ptx`
...
- `Software/Conductor-MacOS/FlashlightsInTheDark_MacOS/View/EventTriggerStrip.swift`
...
- `Software/Singer-Client/lib/model/event_recipe.dart`

But the score-practice MusicXML asset path is hardcoded here:

- `Software/Singer-Client/lib/utils/music_xml_utils.dart`

And the asset is explicitly registered here:

- `Software/Singer-Client/pubspec.yaml`
...
- the "192 event recipes" comment in `Software/Singer-Client/lib/model/client_state.dart`
...
- `Engraving/Scores/FlashlightsInTheDark_v32_TourCut.musicxml`
- `Operations/Scripts/generate_event_recipes_v4.py`
...
- `Software/Singer-Client/assets/FlashlightsInTheDark_v32_TourCut.musicxml`
- `Software/Singer-Client/lib/utils/music_xml_utils.dart`
- `Software/Singer-Client/pubspec.yaml`
...
- `DAW-Production/ProTools-Session/Audio Files/`
- optionally the generated timeline outputs in `DAW-Production/Audits/`

### Validation layer

- `DAW-Production/Audits/event_timeline_events.csv`
- `DAW-Production/Audits/event_timeline_clips.csv`
...
1. confirm the current working cut in `Documentation/Project-Management/2026-03-13-rehearsal-cut-plan.md`
