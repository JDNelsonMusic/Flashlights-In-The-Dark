...
Use these anchors against the official trigger positions documented in `Show-Control/Trigger-Maps/official_trigger_positions.md` and stored in `Show-Control/Event-Recipes/Flashlights-ITD_EventRecipes_4_2026_0309/official_trigger_positions.csv`.

## Stereo Sum Anchor

- Source file: `DAW-Production/Exports/electronics/2026_0314_FlashlightsInTheDark_Electronics-StereoSum_7.mp3`
...
- Derived tour-cut source file: `DAW-Production/Exports/electronics/2026_0314_FlashlightsInTheDark_Electronics-StereoSum_7_TourCut.mp3`
