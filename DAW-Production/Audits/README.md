...
This folder contains the first-pass housekeeping outputs for the Pro Tools materials in `DAW-Production/ProTools-Session`.

## Canonical Sources

- Working session candidate: `DAW-Production/ProTools-Session/2025_0727_FlashlightsInTheDark22_MappingPrimerTones_3.r.ptx`
- Cue bundle: `Show-Control/Event-Recipes/Flashlights-ITD_EventRecipes_4_2026_0309/event_recipes.json`
- Score timing source: `Engraving/Scores/FlashlightsInTheDark_v32_TourCut.musicxml`
- Runtime recipe copies: identical across the recipe bundle, macOS resources, and Flutter assets
- Runtime primer assets remain archived in the repo, but the Flutter runtime now uses the reduced tour-cut electronics bundle instead of bundled primer playback
...
- `electronics_sync_reference.md`: manually maintained timing anchors for aligning rendered electronics audio with score measures while deriving the reduced tour-cut trigger bundle
...
python3 Operations/Scripts/build_protools_event_timeline.py
```
